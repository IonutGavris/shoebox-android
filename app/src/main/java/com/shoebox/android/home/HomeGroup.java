...
public class HomeGroup  extends MyTabActivity 
{
	public static HomeGroup self;
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		Intent sprint = new Intent(HomeGroup.this, HomeActivity.class);
	...
	private class ContactsTask extends AsyncTask<Void, Void, Void>
	{
		...
		{
			progress = ProgressDialog.show(HomeGroup.this, null, "Loading data...");
			super.onPreExecute();
		}
